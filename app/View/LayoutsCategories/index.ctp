<div class="layoutsCategories index">
	<h2><?php echo __('Layouts Categories'); ?></h2>
	...
	<?php foreach ($layoutsCategories as $layoutsCategory): ?>
	<tr>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $layoutsCategory['LayoutsCategory']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $layoutsCategory['LayoutsCategory']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $layoutsCategory['LayoutsCategory']['id']), null, __('Are you sure you want to delete # %s?', $layoutsCategory['LayoutsCategory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
